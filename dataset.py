...
usable_data_sets = {"full": ("dataset/ontonotes4/train.mix.bmes",
                    ...
                    "segpred.traingold": ("dataset/ontonotes4/train.mix.bmes",
                                          "dataset/ontonotes4/dev.mix.segpred.bmes",
                                          "dataset/ontonotes4/test.mix.segpred.bmes"),
                    "allpred": ("dataset/ontonotes4/train.mix.allpred.bmes",
                                "dataset/ontonotes4/dev.mix.allpred.bmes",
                                "dataset/ontonotes4/test.mix.allpred.bmes"),
                    "allpred.traingold": ("dataset/ontonotes4/train.mix.bmes",
                                          "dataset/ontonotes4/dev.mix.allpred.bmes",
                                          "dataset/ontonotes4/test.mix.allpred.bmes"),
